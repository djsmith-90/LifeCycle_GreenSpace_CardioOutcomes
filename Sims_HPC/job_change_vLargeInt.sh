...
#SBATCH --job-name=change_vLargeInt
...
#SBATCH --error=/user/home/ds16565/LifeCycle/Error/Error_change_vLargeInt.txt # Error files (if any)
#SBATCH --output=/user/home/ds16565/LifeCycle/Output/Output_change_vLargeInt.txt # SLURM output file
...
# Run the R script
srun Rscript /user/home/ds16565/LifeCycle/Scripts/change_vLargeInt.r
