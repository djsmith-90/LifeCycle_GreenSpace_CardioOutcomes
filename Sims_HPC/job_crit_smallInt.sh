...
#SBATCH --error=/user/home/ds16565/LifeCycle/Error/Error_crit_smallInt.txt # Error files (if any)
#SBATCH --output=/user/home/ds16565/LifeCycle/Output/Output_crit_smallInt.txt # SLURM output file
...
# Run the R script
srun Rscript /user/home/ds16565/LifeCycle/Scripts/crit_smallInt.r
