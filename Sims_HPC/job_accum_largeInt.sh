...
#SBATCH --job-name=accum_largeInt
...
#SBATCH --error=/user/home/ds16565/LifeCycle/Error/Error_accum_largeInt.txt # Error files (if any)
#SBATCH --output=/user/home/ds16565/LifeCycle/Output/Output_accum_largeInt.txt # SLURM output file
...
# Run the R script
srun Rscript /user/home/ds16565/LifeCycle/Scripts/accum_largeInt.r
