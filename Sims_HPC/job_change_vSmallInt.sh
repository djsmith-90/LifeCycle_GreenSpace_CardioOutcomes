...
#SBATCH --job-name=change_vSmallInt
...
#SBATCH --error=/user/home/ds16565/LifeCycle/Error/Error_change_vSmallInt.txt # Error files (if any)
#SBATCH --output=/user/home/ds16565/LifeCycle/Output/Output_change_vSmallInt.txt # SLURM output file
...
# Run the R script
srun Rscript /user/home/ds16565/LifeCycle/Scripts/change_vSmallInt.r
