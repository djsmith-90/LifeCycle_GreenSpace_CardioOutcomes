...
#SBATCH --job-name=accum_moderateInt
...
#SBATCH --error=/user/home/ds16565/LifeCycle/Error/Error_accum_moderateInt.txt # Error files (if any)
#SBATCH --output=/user/home/ds16565/LifeCycle/Output/Output_accum_moderateInt.txt # SLURM output file
...
# Run the R script
srun Rscript /user/home/ds16565/LifeCycle/Scripts/accum_moderateInt.r
