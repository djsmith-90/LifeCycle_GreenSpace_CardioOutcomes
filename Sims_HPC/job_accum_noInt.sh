...
#SBATCH --error=/user/home/ds16565/LifeCycle/Error/Error_accum_noInt.txt # Error files (if any)
#SBATCH --output=/user/home/ds16565/LifeCycle/Output/Output_accum_noInt.txt # SLURM output file
...
# Run the R script
srun Rscript /user/home/ds16565/LifeCycle/Scripts/accum_noInt.r
